      ...
      <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Cococoding é um time de desenvolvedores que tem como objetivo ajudar pessoas a se tornarem desenvolvedores.
          </p>
        </div>
            ...
            <li key={person.name}>
              <div className="flex items-center gap-x-6">
                ...
                <div>
                  ...
                  <a href="#" className="text-sm font-semibold leading-6 text-indigo-600">{person.linkedin}</a>
                </div>
              </div>
            </li>
          ))}
